...
![](https://goodmanfielder.com/assets/Uploads/nz-home-food-small.png)

# **Food Consumption and CO2 Emission**
...
```{r}
food_prep <- prep(food_rec, training = food_train)
```
